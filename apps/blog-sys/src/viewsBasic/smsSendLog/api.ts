...
enum Api {
  delete = '/xianfu/sys/basic/smsSendLog/delete',
  detail = '/xianfu/sys/basic/smsSendLog/detail/',
  disable = '/xianfu/sys/basic/smsSendLog/disable',
  enable = '/xianfu/sys/basic/smsSendLog/enable',
  existName = '/xianfu/sys/basic/smsSendLog/existName',
  exportExcel = '/xianfu/sys/basic/smsSendLog/exportExcel',
  list = '/xianfu/sys/basic/smsSendLog/query',
  physicalDeletion = '/xianfu/sys/basic/smsSendLog/physicalDeletion',
  recovery = '/xianfu/sys/basic/smsSendLog/recovery',
  selectNodeAllPublic = '/xianfu/sys/basic/smsSendLog/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/basic/smsSendLog/selectNodePublic',
  selectPublic = '/xianfu/sys/basic/smsSendLog/selectPublic',
  state = '/xianfu/sys/basic/smsSendLog/state',
}
