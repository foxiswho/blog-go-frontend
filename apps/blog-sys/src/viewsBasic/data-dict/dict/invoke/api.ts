...
enum Api {
  create = '/xianfu/sys/basic/data-dictionary-sub/create',
  createUpdate = '/xianfu/sys/basic/data-dictionary-sub/createUpdate',
  delete = '/xianfu/sys/basic/data-dictionary-sub/delete',
  detail = '/xianfu/sys/basic/data-dictionary-sub/detail/',
  disable = '/xianfu/sys/basic/data-dictionary-sub/disable',
  enable = '/xianfu/sys/basic/data-dictionary-sub/enable',
  existName = '/xianfu/sys/basic/data-dictionary-sub/existName',
  existCode = '/xianfu/sys/basic/data-dictionary-sub/existCode',
  existValue = '/xianfu/sys/basic/data-dictionary-sub/existValue',
  exportExcel = '/xianfu/sys/basic/data-dictionary-sub/exportExcel',
  list = '/xianfu/sys/basic/data-dictionary-sub/query',
  physicalDeletion = '/xianfu/sys/basic/data-dictionary-sub/physicalDeletion',
  recovery = '/xianfu/sys/basic/data-dictionary-sub/recovery',
  selectNodeAllPublic = '/xianfu/sys/basic/data-dictionary-sub/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/basic/data-dictionary-sub/selectNodePublic',
  selectPublic = '/xianfu/sys/basic/data-dictionary-sub/selectPublic',
  state = '/xianfu/sys/basic/data-dictionary-sub/state',
  update = '/xianfu/sys/basic/data-dictionary-sub/update',
}
