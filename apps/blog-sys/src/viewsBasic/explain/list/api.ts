...
enum Api {
  create = '/pg2lq/sys/basic/explain/create',
  delete = '/pg2lq/sys/basic/explain/delete',
  detail = '/pg2lq/sys/basic/explain/detail/',
  disable = '/pg2lq/sys/basic/explain/disable',
  enable = '/pg2lq/sys/basic/explain/enable',
  existName = '/pg2lq/sys/basic/explain/existName',
  exportExcel = '/pg2lq/sys/basic/explain/exportExcel',
  list = '/pg2lq/sys/basic/explain/query',
  listByGroup = '/pg2lq/sys/basic/explain/queryByGroup',
  physicalDeletion = '/pg2lq/sys/basic/explain/physicalDeletion',
  recovery = '/pg2lq/sys/basic/explain/recovery',
  selectNodeAllPublic = '/pg2lq/sys/basic/explain/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/sys/basic/explain/selectNodePublic',
  selectPublic = '/pg2lq/sys/basic/explain/selectPublic',
  state = '/pg2lq/sys/basic/explain/state',
  update = '/pg2lq/sys/basic/explain/update',
  updateByMenu = '/pg2lq/sys/basic/explain/updateByMenu',
}
