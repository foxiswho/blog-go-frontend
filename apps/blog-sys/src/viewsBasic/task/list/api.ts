...
enum Api {
  create = '/pg2lq/sys/basic/task/create',
  delete = '/pg2lq/sys/basic/task/delete',
  detail = '/pg2lq/sys/basic/task/detail/',
  disable = '/pg2lq/sys/basic/task/disable',
  enable = '/pg2lq/sys/basic/task/enable',
  existName = '/pg2lq/sys/basic/task/existName',
  exportExcel = '/pg2lq/sys/basic/task/exportExcel',
  list = '/pg2lq/sys/basic/task/query',
  listByGroup = '/pg2lq/sys/basic/task/queryByGroup',
  physicalDeletion = '/pg2lq/sys/basic/task/physicalDeletion',
  recovery = '/pg2lq/sys/basic/task/recovery',
  selectNodeAllPublic = '/pg2lq/sys/basic/task/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/sys/basic/task/selectNodePublic',
  selectPublic = '/pg2lq/sys/basic/task/selectPublic',
  state = '/pg2lq/sys/basic/task/state',
  update = '/pg2lq/sys/basic/task/update',
  updateByMenu = '/pg2lq/sys/basic/task/updateByMenu',
}
