...
enum Api {
  create = '/xianfu/sys/basic/module/create',
  createUpdate = '/xianfu/sys/basic/module/createUpdate',
  delete = '/xianfu/sys/basic/module/delete',
  detail = '/xianfu/sys/basic/module/detail/',
  disable = '/xianfu/sys/basic/module/disable',
  enable = '/xianfu/sys/basic/module/enable',
  existName = '/xianfu/sys/basic/module/existName',
  ...
  selectNodeAllPublic = '/xianfu/sys/basic/module/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/basic/module/selectNodePublic',
  selectPublic = '/xianfu/sys/basic/module/selectPublic',
  state = '/xianfu/sys/basic/module/state',
  update = '/xianfu/sys/basic/module/update',
}
