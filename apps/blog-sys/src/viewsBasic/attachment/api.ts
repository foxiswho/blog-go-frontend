...
enum Api {
  create = '/pg2lq/sys/basic/attachment/create',
  delete = '/pg2lq/sys/basic/attachment/delete',
  detail = '/pg2lq/sys/basic/attachment/detail/',
  disable = '/pg2lq/sys/basic/attachment/disable',
  enable = '/pg2lq/sys/basic/attachment/enable',
  existName = '/pg2lq/sys/basic/attachment/existName',
  exportExcel = '/pg2lq/sys/basic/attachment/exportExcel',
  list = '/pg2lq/sys/basic/attachment/query',
  physicalDeletion = '/pg2lq/sys/basic/attachment/physicalDeletion',
  recovery = '/pg2lq/sys/basic/attachment/recovery',
  selectNodeAllPublic = '/pg2lq/sys/basic/attachment/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/sys/basic/attachment/selectNodePublic',
