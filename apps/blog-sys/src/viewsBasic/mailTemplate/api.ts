...
enum Api {
  createUpdate = '/xianfu/sys/basic/mailTemplate/createUpdate',
  delete = '/xianfu/sys/basic/mailTemplate/delete',
  detail = '/xianfu/sys/basic/mailTemplate/detail/',
  disable = '/xianfu/sys/basic/mailTemplate/disable',
  enable = '/xianfu/sys/basic/mailTemplate/enable',
  existName = '/xianfu/sys/basic/mailTemplate/existName',
  existSpTemplateCode = '/xianfu/sys/basic/mailTemplate/existSpTemplateCode',
  exportExcel = '/xianfu/sys/basic/mailTemplate/exportExcel',
  list = '/xianfu/sys/basic/mailTemplate/query',
  physicalDeletion = '/xianfu/sys/basic/mailTemplate/physicalDeletion',
  recovery = '/xianfu/sys/basic/mailTemplate/recovery',
  selectNodeAllPublic = '/xianfu/sys/basic/mailTemplate/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/basic/mailTemplate/selectNodePublic',
  state = '/xianfu/sys/basic/mailTemplate/state',
}
 ...
 * @param params
 */
export const existSpTemplateCode = (wd, id?,spCode?:string) => {
  id = id || '0';
  return requestClient.post(
    Api.existSpTemplateCode,
    { wd, id,ext:{spCode:spCode} },
    { errorMessageMode: 'message', successMessageMode: 'notification' },
  );
};
