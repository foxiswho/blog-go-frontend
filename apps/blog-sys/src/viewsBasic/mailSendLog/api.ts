...
enum Api {
  delete = '/xianfu/sys/basic/mailSendLog/delete',
  detail = '/xianfu/sys/basic/mailSendLog/detail/',
  disable = '/xianfu/sys/basic/mailSendLog/disable',
  enable = '/xianfu/sys/basic/mailSendLog/enable',
  existName = '/xianfu/sys/basic/mailSendLog/existName',
  exportExcel = '/xianfu/sys/basic/mailSendLog/exportExcel',
  list = '/xianfu/sys/basic/mailSendLog/query',
  physicalDeletion = '/xianfu/sys/basic/mailSendLog/physicalDeletion',
  recovery = '/xianfu/sys/basic/mailSendLog/recovery',
  selectNodeAllPublic = '/xianfu/sys/basic/mailSendLog/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/basic/mailSendLog/selectNodePublic',
  selectPublic = '/xianfu/sys/basic/mailSendLog/selectPublic',
  state = '/xianfu/sys/basic/mailSendLog/state',
}
