...
enum Api {
  create = '/xianfu/sys/basic/smsMailCategory/create',
  createUpdate = '/xianfu/sys/basic/smsMailCategory/createUpdate',
  delete = '/xianfu/sys/basic/smsMailCategory/delete',
  detail = '/xianfu/sys/basic/smsMailCategory/detail/',
  disable = '/xianfu/sys/basic/smsMailCategory/disable',
  enable = '/xianfu/sys/basic/smsMailCategory/enable',
  existName = '/xianfu/sys/basic/smsMailCategory/existName',
  existCode = '/xianfu/sys/basic/smsMailCategory/existCode',
  exportExcel = '/xianfu/sys/basic/smsMailCategory/exportExcel',
  list = '/xianfu/sys/basic/smsMailCategory/query',
  queryAll = '/xianfu/sys/basic/smsMailCategory/queryAll',
  physicalDeletion = '/xianfu/sys/basic/smsMailCategory/physicalDeletion',
  recovery = '/xianfu/sys/basic/smsMailCategory/recovery',
  selectNodeAll = '/xianfu/sys/basic/smsMailCategory/selectNodeAll',
  selectNodeAllPublic = '/xianfu/sys/basic/smsMailCategory/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/basic/smsMailCategory/selectNodePublic',
  selectPublic = '/xianfu/sys/basic/smsMailCategory/selectPublic',
  state = '/xianfu/sys/basic/smsMailCategory/state',
}
