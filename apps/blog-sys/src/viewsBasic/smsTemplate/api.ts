...
enum Api {
  createUpdate = '/xianfu/sys/basic/smsTemplate/createUpdate',
  delete = '/xianfu/sys/basic/smsTemplate/delete',
  detail = '/xianfu/sys/basic/smsTemplate/detail/',
  disable = '/xianfu/sys/basic/smsTemplate/disable',
  enable = '/xianfu/sys/basic/smsTemplate/enable',
  existName = '/xianfu/sys/basic/smsTemplate/existName',
  existSpTemplateCode = '/xianfu/sys/basic/smsTemplate/existSpTemplateCode',
  exportExcel = '/xianfu/sys/basic/smsTemplate/exportExcel',
  list = '/xianfu/sys/basic/smsTemplate/query',
  physicalDeletion = '/xianfu/sys/basic/smsTemplate/physicalDeletion',
  recovery = '/xianfu/sys/basic/smsTemplate/recovery',
  selectNodeAllPublic = '/xianfu/sys/basic/smsTemplate/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/basic/smsTemplate/selectNodePublic',
  state = '/xianfu/sys/basic/smsTemplate/state',
}
