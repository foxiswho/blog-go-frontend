...
enum Api {
  create = '/pg2lq/sys/tc/tenant-domain/create',
  delete = '/pg2lq/sys/tc/tenant-domain/delete',
  detail = '/pg2lq/sys/tc/tenant-domain/detail/',
  disable = '/pg2lq/sys/tc/tenant-domain/disable',
  enable = '/pg2lq/sys/tc/tenant-domain/enable',
  existName = '/pg2lq/sys/tc/tenant-domain/existName',
  existCode = '/pg2lq/sys/tc/tenant-domain/existCode',
  exportExcel = '/pg2lq/sys/tc/tenant-domain/exportExcel',
  list = '/pg2lq/sys/tc/tenant-domain/query',
  physicalDeletion = '/pg2lq/sys/tc/tenant-domain/physicalDeletion',
  recovery = '/pg2lq/sys/tc/tenant-domain/recovery',
  selectNodeAllPublic = '/pg2lq/sys/tc/tenant-domain/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/sys/tc/tenant-domain/selectNodePublic',
  selectPublic = '/pg2lq/sys/tc/tenant-domain/selectPublic',
  state = '/pg2lq/sys/tc/tenant-domain/state',
  setDefaulted = '/pg2lq/sys/tc/tenant-domain/setDefaulted',
  update = '/pg2lq/sys/tc/tenant-domain/update',
}
