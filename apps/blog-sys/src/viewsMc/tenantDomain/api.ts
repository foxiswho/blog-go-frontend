...
enum Api {
  create = '/xianfu/sys/tc/tenant-domain/create',
  delete = '/xianfu/sys/tc/tenant-domain/delete',
  detail = '/xianfu/sys/tc/tenant-domain/detail/',
  disable = '/xianfu/sys/tc/tenant-domain/disable',
  enable = '/xianfu/sys/tc/tenant-domain/enable',
  existName = '/xianfu/sys/tc/tenant-domain/existName',
  existCode = '/xianfu/sys/tc/tenant-domain/existCode',
  exportExcel = '/xianfu/sys/tc/tenant-domain/exportExcel',
  list = '/xianfu/sys/tc/tenant-domain/query',
  physicalDeletion = '/xianfu/sys/tc/tenant-domain/physicalDeletion',
  recovery = '/xianfu/sys/tc/tenant-domain/recovery',
  selectNodeAllPublic = '/xianfu/sys/tc/tenant-domain/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/tc/tenant-domain/selectNodePublic',
  selectPublic = '/xianfu/sys/tc/tenant-domain/selectPublic',
  state = '/xianfu/sys/tc/tenant-domain/state',
  setDefaulted = '/xianfu/sys/tc/tenant-domain/setDefaulted',
  update = '/xianfu/sys/tc/tenant-domain/update',
}
 ...
 * 批量-默认
 * @param id
 * @param status 1 是 2 否
 */
export const setDefaulted = (id: number, status: number) =>
  requestClient.post(
    Api.setDefaulted,
    { ids: [id], state: status },
    { errorMessageMode: 'message', successMessageMode: 'message' },
