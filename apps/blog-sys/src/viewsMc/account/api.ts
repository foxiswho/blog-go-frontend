...
enum Api {
  create = '/pg2lq/sys/mc/merchant-account/create',
  createAccount = '/pg2lq/sys/mc/merchant-account/createAccount',
  delete = '/pg2lq/sys/mc/merchant-account/delete',
  detail = '/pg2lq/sys/mc/merchant-account/detail',
  disable = '/pg2lq/sys/mc/merchant-account/disable',
  enable = '/pg2lq/sys/mc/merchant-account/enable',
  existAccount = '/pg2lq/sys/mc/merchant-account/existAccount',
  existMail = '/pg2lq/sys/mc/merchant-account/existMail',
  existName = '/pg2lq/sys/mc/merchant-account/existName',
  existPhone = '/pg2lq/sys/mc/merchant-account/existPhone',
  exportExcel = '/pg2lq/sys/mc/merchant-account/exportExcel',
  list = '/pg2lq/sys/mc/merchant-account/query',
  physicalDeletion = '/pg2lq/sys/mc/merchant-account/physicalDeletion',
  recovery = '/pg2lq/sys/mc/merchant-account/recovery',
  selectNodeAllPublic = '/pg2lq/sys/mc/merchant-account/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/sys/mc/merchant-account/selectNodePublic',
  selectPublic = '/pg2lq/sys/mc/merchant-account/selectPublic',
  state = '/pg2lq/sys/mc/merchant-account/state',
  update = '/pg2lq/sys/mc/merchant-account/update',
  updateAccount = '/pg2lq/sys/mc/merchant-account/updateAccount',
  updatePassword = '/pg2lq/manage/mc/merchant-account/updatePassword',
}
