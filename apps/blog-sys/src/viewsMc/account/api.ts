...
enum Api {
  create = '/xianfu/sys/mc/merchant-account/create',
  createAccount = '/xianfu/sys/mc/merchant-account/createAccount',
  delete = '/xianfu/sys/mc/merchant-account/delete',
  detail = '/xianfu/sys/mc/merchant-account/detail',
  disable = '/xianfu/sys/mc/merchant-account/disable',
  enable = '/xianfu/sys/mc/merchant-account/enable',
  existAccount = '/xianfu/sys/mc/merchant-account/existAccount',
  existMail = '/xianfu/sys/mc/merchant-account/existMail',
  existName = '/xianfu/sys/mc/merchant-account/existName',
  existPhone = '/xianfu/sys/mc/merchant-account/existPhone',
  exportExcel = '/xianfu/sys/mc/merchant-account/exportExcel',
  list = '/xianfu/sys/mc/merchant-account/query',
  physicalDeletion = '/xianfu/sys/mc/merchant-account/physicalDeletion',
  recovery = '/xianfu/sys/mc/merchant-account/recovery',
  selectNodeAllPublic = '/xianfu/sys/mc/merchant-account/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/mc/merchant-account/selectNodePublic',
  selectPublic = '/xianfu/sys/mc/merchant-account/selectPublic',
  state = '/xianfu/sys/mc/merchant-account/state',
  update = '/xianfu/sys/mc/merchant-account/update',
  updateAccount = '/xianfu/sys/mc/merchant-account/updateAccount',
  updatePassword = '/xianfu/manage/mc/merchant-account/updatePassword',
}
...
export const detail = (data?: any) => {
  return requestClient.post(Api.detail, data);
};
