...
enum Api {
  create = '/xianfu/sys/ram/resource/create',
  createUpdate = '/xianfu/sys/ram/resource/createUpdate',
  createUpdateByCategory = '/xianfu/sys/ram/resource/createUpdateByCategory',
  delete = '/xianfu/sys/ram/resource/delete',
  detail = '/xianfu/sys/ram/resource/detail/',
  disable = '/xianfu/sys/ram/resource/disable',
  enable = '/xianfu/sys/ram/resource/enable',
  existName = '/xianfu/sys/ram/resource/existName',
  exportExcel = '/xianfu/sys/ram/resource/exportExcel',
  list = '/xianfu/sys/ram/resource/query',
  physicalDeletion = '/xianfu/sys/ram/resource/physicalDeletion',
  recovery = '/xianfu/sys/ram/resource/recovery',
  selectCategory = '/xianfu/sys/ram/resource/selectCategory',
  selectCategoryPublic = '/xianfu/sys/ram/resource/selectCategoryPublic',
  selectNodeAll = '/xianfu/sys/ram/resource/selectNodeAll',
  selectNodeAllPublic = '/xianfu/sys/ram/resource/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/ram/resource/selectNodePublic',
  selectPublic = '/xianfu/sys/ram/resource/selectPublic',
  state = '/xianfu/sys/ram/resource/state',
  update = '/xianfu/sys/ram/resource/update',
}
