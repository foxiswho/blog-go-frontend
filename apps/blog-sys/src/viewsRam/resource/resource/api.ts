...
enum Api {
  ...
  enable = '/pg2lq/sys/ram/resource/enable',
  existName = '/pg2lq/sys/ram/resource/existName',
  exportExcel = '/pg2lq/sys/ram/resource/exportExcel',
  ...
  state = '/pg2lq/sys/ram/resource/state',
  update = '/pg2lq/sys/ram/resource/update',
}
