...
enum Api {
  ...
  enable = '/pg2lq/sys/ram/resource-group/enable',
  existName = '/pg2lq/sys/ram/resource-group/existName',
  exportExcel = '/pg2lq/sys/ram/resource-group/exportExcel',
  ...
  update = '/pg2lq/sys/ram/resource-group/update',
}
