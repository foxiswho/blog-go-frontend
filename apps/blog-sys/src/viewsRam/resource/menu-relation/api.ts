...
enum Api {
  create = '/xianfu/sys/ram/menu-relation/create',
  delete = '/xianfu/sys/ram/menu-relation/delete',
  detail = '/xianfu/sys/ram/menu-relation/detail/',
  disable = '/xianfu/sys/ram/menu-relation/disable',
  enable = '/xianfu/sys/ram/menu-relation/enable',
  existName = '/xianfu/sys/ram/menu-relation/existName',
  exportExcel = '/xianfu/sys/ram/menu-relation/exportExcel',
  list = '/xianfu/sys/ram/menu-relation/query',
  listByGroup = '/xianfu/sys/ram/menu-relation/queryByGroup',
  physicalDeletion = '/xianfu/sys/ram/menu-relation/physicalDeletion',
  recovery = '/xianfu/sys/ram/menu-relation/recovery',
  selectNodeAllPublic = '/xianfu/sys/ram/menu-relation/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/ram/menu-relation/selectNodePublic',
  selectPublic = '/xianfu/sys/ram/menu-relation/selectPublic',
  state = '/xianfu/sys/ram/menu-relation/state',
  update = '/xianfu/sys/ram/menu-relation/update',
  updateByMenu = '/xianfu/sys/ram/menu-relation/updateByMenu',
}
 ...
 * @param data
 */
export const updateByMenu = (data: any) => {
  return requestClient.post(Api.updateByMenu, data, {
    errorMessageMode: 'message',
    successMessageMode: 'notification',
  });
};
