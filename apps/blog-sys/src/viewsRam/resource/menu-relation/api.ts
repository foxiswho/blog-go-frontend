...
enum Api {
  create = '/pg2lq/sys/ram/menu-relation/create',
  delete = '/pg2lq/sys/ram/menu-relation/delete',
  detail = '/pg2lq/sys/ram/menu-relation/detail/',
  disable = '/pg2lq/sys/ram/menu-relation/disable',
  enable = '/pg2lq/sys/ram/menu-relation/enable',
  existName = '/pg2lq/sys/ram/menu-relation/existName',
  exportExcel = '/pg2lq/sys/ram/menu-relation/exportExcel',
  list = '/pg2lq/sys/ram/menu-relation/query',
  listByGroup = '/pg2lq/sys/ram/menu-relation/queryByGroup',
  physicalDeletion = '/pg2lq/sys/ram/menu-relation/physicalDeletion',
  recovery = '/pg2lq/sys/ram/menu-relation/recovery',
  selectNodeAllPublic = '/pg2lq/sys/ram/menu-relation/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/sys/ram/menu-relation/selectNodePublic',
  selectPublic = '/pg2lq/sys/ram/menu-relation/selectPublic',
  state = '/pg2lq/sys/ram/menu-relation/state',
  update = '/pg2lq/sys/ram/menu-relation/update',
  updateByMenu = '/pg2lq/sys/ram/menu-relation/updateByMenu',
}
