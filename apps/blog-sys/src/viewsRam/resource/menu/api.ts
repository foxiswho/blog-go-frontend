...
enum Api {
  create = '/xianfu/sys/ram/menu/create',
  createUpdate = '/xianfu/sys/ram/menu/createUpdate',
  delete = '/xianfu/sys/ram/menu/delete',
  detail = '/xianfu/sys/ram/menu/detail/',
  disable = '/xianfu/sys/ram/menu/disable',
  enable = '/xianfu/sys/ram/menu/enable',
  ...
  selectNodePublic = '/xianfu/sys/ram/menu/selectNodePublic',
  selectPublic = '/xianfu/sys/ram/menu/selectPublic',
  state = '/xianfu/sys/ram/menu/state',
  update = '/xianfu/sys/ram/menu/update',
}
