...
enum Api {
  create = '/pg2lq/sys/ram/account/create',
  createUpdate = '/pg2lq/sys/ram/account/createUpdate',
  createAccount = '/pg2lq/sys/ram/account/createAccount',
  createUpdateSimple = '/pg2lq/sys/ram/account/createUpdateSimple',
  delete = '/pg2lq/sys/ram/account/delete',
  detail = '/pg2lq/sys/ram/account/detail/',
  disable = '/pg2lq/sys/ram/account/disable',
  enable = '/pg2lq/sys/ram/account/enable',
  existAccount = '/pg2lq/sys/ram/account/existAccount',
  existMail = '/pg2lq/sys/ram/account/existMail',
  existName = '/pg2lq/sys/ram/account/existName',
  existPhone = '/pg2lq/sys/ram/account/existPhone',
  existCode = '/pg2lq/sys/ram/account/existCode',
  exportExcel = '/pg2lq/sys/ram/account/exportExcel',
  list = '/pg2lq/sys/ram/account/query',
  physicalDeletion = '/pg2lq/sys/ram/account/physicalDeletion',
  recovery = '/pg2lq/sys/ram/account/recovery',
  selectNodeAllPublic = '/pg2lq/sys/ram/account/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/sys/ram/account/selectNodePublic',
  selectPublic = '/pg2lq/sys/ram/account/selectPublic',
  state = '/pg2lq/sys/ram/account/state',
  update = '/pg2lq/sys/ram/account/update',
  updateAccount = '/pg2lq/sys/ram/account/updateAccount',
  updatePassword = '/pg2lq/sys/ram/account/updatePassword',
}
