...
enum Api {
  create = '/xianfu/sys/ram/job-function/create',
  createUpdate = '/xianfu/sys/ram/job-function/createUpdate',
  delete = '/xianfu/sys/ram/job-function/delete',
  detail = '/xianfu/sys/ram/job-function/detail/',
  disable = '/xianfu/sys/ram/job-function/disable',
  enable = '/xianfu/sys/ram/job-function/enable',
  existName = '/xianfu/sys/ram/job-function/existName',
  exportExcel = '/xianfu/sys/ram/job-function/exportExcel',
  list = '/xianfu/sys/ram/job-function/query',
  physicalDeletion = '/xianfu/sys/ram/job-function/physicalDeletion',
  recovery = '/xianfu/sys/ram/job-function/recovery',
  selectNodeAllPublic = '/xianfu/sys/ram/job-function/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/ram/job-function/selectNodePublic',
  selectPublic = '/xianfu/sys/ram/job-function/selectPublic',
  state = '/xianfu/sys/ram/job-function/state',
  update = '/xianfu/sys/ram/job-function/update',
}
