...
enum Api {
  create = '/xianfu/sys/ram/department/create',
  createUpdate = '/xianfu/sys/ram/department/createUpdate',
  delete = '/xianfu/sys/ram/department/delete',
  detail = '/xianfu/sys/ram/department/detail/',
  disable = '/xianfu/sys/ram/department/disable',
  enable = '/xianfu/sys/ram/department/enable',
  existName = '/xianfu/sys/ram/department/existName',
  exportExcel = '/xianfu/sys/ram/department/exportExcel',
  list = '/xianfu/sys/ram/department/query',
  queryAll = '/xianfu/sys/ram/department/queryAll',
  physicalDeletion = '/xianfu/sys/ram/department/physicalDeletion',
  recovery = '/xianfu/sys/ram/department/recovery',
  selectNodeAll = '/xianfu/sys/ram/department/selectNodeAll',
  selectNodeAllPublic = '/xianfu/sys/ram/department/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/ram/department/selectNodePublic',
  selectPublic = '/xianfu/sys/ram/department/selectPublic',
  state = '/xianfu/sys/ram/department/state',
  update = '/xianfu/sys/ram/department/update',
}
