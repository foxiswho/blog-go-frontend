...
enum Api {
  create = '/xianfu/sys/tc/tenant-account/create',
  createAccount = '/xianfu/sys/tc/tenant-account/createAccount',
  delete = '/xianfu/sys/tc/tenant-account/delete',
  detail = '/xianfu/sys/tc/tenant-account/detail/',
  disable = '/xianfu/sys/tc/tenant-account/disable',
  enable = '/xianfu/sys/tc/tenant-account/enable',
  existAccount = '/xianfu/sys/tc/tenant-account/existAccount',
  existMail = '/xianfu/sys/tc/tenant-account/existMail',
  existName = '/xianfu/sys/tc/tenant-account/existName',
  existCode = '/xianfu/sys/tc/tenant-account/existCode',
  existPhone = '/xianfu/sys/tc/tenant-account/existPhone',
  existIdentityCode = '/xianfu/sys/tc/tenant-account/existIdentityCode',
  existRealName = '/xianfu/sys/tc/tenant-account/existRealName',
  exportExcel = '/xianfu/sys/tc/tenant-account/exportExcel',
  list = '/xianfu/sys/tc/tenant-account/query',
  physicalDeletion = '/xianfu/sys/tc/tenant-account/physicalDeletion',
  recovery = '/xianfu/sys/tc/tenant-account/recovery',
  selectNodeAllPublic = '/xianfu/sys/tc/tenant-account/selectNodeAllPublic',
  selectNodePublic = '/xianfu/sys/tc/tenant-account/selectNodePublic',
  selectPublic = '/xianfu/sys/tc/tenant-account/selectPublic',
  state = '/xianfu/sys/tc/tenant-account/state',
  update = '/xianfu/sys/tc/tenant-account/update',
  updateAccount = '/xianfu/sys/tc/tenant-account/updateAccount',
  updatePassword = '/xianfu/sys/tc/tenant-account/updatePassword',
}
