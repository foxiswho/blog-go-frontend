...
enum Api {
  create = '/pg2lq/manage/iam/account/create',
  createAccount = '/pg2lq/manage/iam/account/createAccount',
  delete = '/pg2lq/manage/iam/account/delete',
  detail = '/pg2lq/manage/iam/account/detail/',
  disable = '/pg2lq/manage/iam/account/disable',
  enable = '/pg2lq/manage/iam/account/enable',
  existAccount = '/pg2lq/manage/iam/account/existAccount',
  existMail = '/pg2lq/manage/iam/account/existMail',
  existName = '/pg2lq/manage/iam/account/existName',
  existPhone = '/pg2lq/manage/iam/account/existPhone',
  exportExcel = '/pg2lq/manage/iam/account/exportExcel',
  list = '/pg2lq/manage/iam/account/query',
  physicalDeletion = '/pg2lq/manage/iam/account/physicalDeletion',
  recovery = '/pg2lq/manage/iam/account/recovery',
  selectNodeAllPublic = '/pg2lq/manage/iam/account/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/manage/iam/account/selectNodePublic',
  selectPublic = '/pg2lq/manage/iam/account/selectPublic',
  state = '/pg2lq/manage/iam/account/state',
  update = '/pg2lq/manage/iam/account/update',
  updateAccount = '/pg2lq/manage/iam/account/updateAccount',
  updatePassword = '/pg2lq/manage/iam/account/updatePassword',
}
