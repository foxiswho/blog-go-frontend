...
enum Api {
  create = '/pg2lq/sys/iam/menu-relation/create',
  delete = '/pg2lq/sys/iam/menu-relation/delete',
  detail = '/pg2lq/sys/iam/menu-relation/detail/',
  disable = '/pg2lq/sys/iam/menu-relation/disable',
  enable = '/pg2lq/sys/iam/menu-relation/enable',
  existName = '/pg2lq/sys/iam/menu-relation/existName',
  exportExcel = '/pg2lq/sys/iam/menu-relation/exportExcel',
  list = '/pg2lq/sys/iam/menu-relation/query',
  listByGroup = '/pg2lq/sys/iam/menu-relation/queryByGroup',
  physicalDeletion = '/pg2lq/sys/iam/menu-relation/physicalDeletion',
  recovery = '/pg2lq/sys/iam/menu-relation/recovery',
  selectNodeAllPublic = '/pg2lq/sys/iam/menu-relation/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/sys/iam/menu-relation/selectNodePublic',
  selectPublic = '/pg2lq/sys/iam/menu-relation/selectPublic',
  state = '/pg2lq/sys/iam/menu-relation/state',
  update = '/pg2lq/sys/iam/menu-relation/update',
  updateByMenu = '/pg2lq/sys/iam/menu-relation/updateByMenu',
}
