...
enum Api {
  create = '/pg2lq/manage/iam/resource-authority/create',
  createByGroup = '/pg2lq/manage/iam/resource-authority/createByGroup',
  delete = '/pg2lq/manage/iam/resource-authority/delete',
  detail = '/pg2lq/manage/iam/resource-authority/detail/',
  disable = '/pg2lq/manage/iam/resource-authority/disable',
  enable = '/pg2lq/manage/iam/resource-authority/enable',
  existName = '/pg2lq/manage/iam/resource-authority/existName',
  exportExcel = '/pg2lq/manage/iam/resource-authority/exportExcel',
  list = '/pg2lq/manage/iam/resource-authority/query',
  listByGroup = '/pg2lq/manage/iam/resource-authority/queryByGroup',
  physicalDeletion = '/pg2lq/manage/iam/resource-authority/physicalDeletion',
  recovery = '/pg2lq/manage/iam/resource-authority/recovery',
  selectNodeAllPublic = '/pg2lq/manage/iam/resource-authority/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/manage/iam/resource-authority/selectNodePublic',
  selectPublic = '/pg2lq/manage/iam/resource-authority/selectPublic',
  selectCategoryPublic = '/pg2lq/manage/iam/resource-authority/selectCategoryPublic',
  state = '/pg2lq/manage/iam/resource-authority/state',
  update = '/pg2lq/manage/iam/resource-authority/update',
  updateByRole = '/pg2lq/manage/iam/resource-authority/updateByRole',
}
