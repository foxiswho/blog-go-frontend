...
enum Api {
  addByTopic = '/xianfu/manage/blog/topic-relation/addByTopic',
  create = '/xianfu/manage/blog/topic-relation/create',
  delete = '/xianfu/manage/blog/topic-relation/delete',
  detail = '/xianfu/manage/blog/topic-relation/detail/',
  disable = '/xianfu/manage/blog/topic-relation/disable',
  enable = '/xianfu/manage/blog/topic-relation/enable',
  existName = '/xianfu/manage/blog/topic-relation/existName',
  existCode = '/xianfu/manage/blog/topic-relation/existCode',
  existCountryCode = '/xianfu/manage/blog/topic-relation/existCountryCode',
  exportExcel = '/xianfu/manage/blog/topic-relation/exportExcel',
  list = '/xianfu/manage/blog/topic-relation/query',
  physicalDeletion = '/xianfu/manage/blog/topic-relation/physicalDeletion',
  recovery = '/xianfu/manage/blog/topic-relation/recovery',
  selectNodeAllPublic = '/xianfu/manage/blog/topic-relation/selectNodeAllPublic',
  selectNodePublic = '/xianfu/manage/blog/topic-relation/selectNodePublic',
  selectPublic = '/xianfu/manage/blog/topic-relation/selectPublic',
  selectPublicCountryCode = '/xianfu/manage/blog/topic-relation/selectPublicCountryCode',
  state = '/xianfu/manage/blog/topic-relation/state',
  update = '/xianfu/manage/blog/topic-relation/update',
}
 ...
 * @param params
 */
export const existCountryCode = (wd, id?) => {
  id = id || '0';
  return requestClient.post(
    Api.existCountryCode,
    { wd, id },
    { errorMessageMode: 'message', successMessageMode: 'notification' },
  );
};
 ...
 * @param data
 */
export const addByTopic = (data?: any) => {
  return requestClient.post(Api.addByTopic, data, {
    errorMessageMode: 'message',
    successMessageMode: 'notification',
  });
};
