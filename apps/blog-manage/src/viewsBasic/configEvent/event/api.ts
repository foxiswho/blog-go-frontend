...
enum Api {
  create = '/pg2lq/manage/basic/configEvent/create',
  createUpdate = '/pg2lq/manage/basic/configEvent/createUpdate',
  delete = '/pg2lq/manage/basic/configEvent/delete',
  detail = '/pg2lq/manage/basic/configEvent/detail/',
  disable = '/pg2lq/manage/basic/configEvent/disable',
  enable = '/pg2lq/manage/basic/configEvent/enable',
  existName = '/pg2lq/manage/basic/configEvent/existName',
  existCode = '/pg2lq/manage/basic/configEvent/existCode',
  existValue = '/pg2lq/manage/basic/configEvent/existValue',
  exportExcel = '/pg2lq/manage/basic/configEvent/exportExcel',
  list = '/pg2lq/manage/basic/configEvent/query',
  allByModel = '/pg2lq/manage/basic/configEvent/allByModel',
  physicalDeletion = '/pg2lq/manage/basic/configEvent/physicalDeletion',
  recovery = '/pg2lq/manage/basic/configEvent/recovery',
  selectNodeAllPublic = '/pg2lq/manage/basic/configEvent/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/manage/basic/configEvent/selectNodePublic',
