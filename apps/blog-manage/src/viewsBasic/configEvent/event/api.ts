...
enum Api {
  create = '/xianfu/manage/basic/configEvent/create',
  createUpdate = '/xianfu/manage/basic/configEvent/createUpdate',
  delete = '/xianfu/manage/basic/configEvent/delete',
  detail = '/xianfu/manage/basic/configEvent/detail/',
  disable = '/xianfu/manage/basic/configEvent/disable',
  enable = '/xianfu/manage/basic/configEvent/enable',
  existName = '/xianfu/manage/basic/configEvent/existName',
  existCode = '/xianfu/manage/basic/configEvent/existCode',
  existValue = '/xianfu/manage/basic/configEvent/existValue',
  exportExcel = '/xianfu/manage/basic/configEvent/exportExcel',
  list = '/xianfu/manage/basic/configEvent/query',
  allByModel = '/xianfu/manage/basic/configEvent/allByModel',
  physicalDeletion = '/xianfu/manage/basic/configEvent/physicalDeletion',
  recovery = '/xianfu/manage/basic/configEvent/recovery',
  selectNodeAllPublic = '/xianfu/manage/basic/configEvent/selectNodeAllPublic',
  selectNodePublic = '/xianfu/manage/basic/configEvent/selectNodePublic',
  selectPublic = '/xianfu/manage/basic/configEvent/selectPublic',
  state = '/xianfu/manage/basic/configEvent/state',
  update = '/xianfu/manage/basic/configEvent/update',
  copy = '/xianfu/manage/basic/configEvent/copy',
  modelForm = '/xianfu/manage/basic/configEvent/modelForm',
}
 ...
 * @param data
 */
export const allByModel = (data?: any) => {
  return requestClient.post(Api.allByModel, data);
};
/**
 * 公共列表展示
 * @param data
