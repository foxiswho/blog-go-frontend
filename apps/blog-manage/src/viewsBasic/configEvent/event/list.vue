  ...
  <div class="grid2 h-full p-2">
    <vxe-grid ref="xGrid" v-bind="gridOptions" v-on="gridEvent">
      <template #operate="{ row }">
        <vxe-button icon="vxe-icon-edit" mode="text" status="primary" @click="editRowEvent(row)">编辑</vxe-button>
        <vxe-button icon="vxe-icon-delete" mode="text" status="danger" @click="removeRowEvent(row)">删除</vxe-button>
      </template>
    </vxe-grid>
