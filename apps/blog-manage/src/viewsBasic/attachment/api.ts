...
enum Api {
  create = '/pg2lq/manage/basic/attachment/create',
  delete = '/pg2lq/manage/basic/attachment/delete',
  detail = '/pg2lq/manage/basic/attachment/detail/',
  disable = '/pg2lq/manage/basic/attachment/disable',
  enable = '/pg2lq/manage/basic/attachment/enable',
  existName = '/pg2lq/manage/basic/attachment/existName',
  exportExcel = '/pg2lq/manage/basic/attachment/exportExcel',
  list = '/pg2lq/manage/basic/attachment/query',
  physicalDeletion = '/pg2lq/manage/basic/attachment/physicalDeletion',
  recovery = '/pg2lq/manage/basic/attachment/recovery',
  selectNodeAllPublic = '/pg2lq/manage/basic/attachment/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/manage/basic/attachment/selectNodePublic',
  selectPublic = '/pg2lq/manage/basic/attachment/selectPublic',
  state = '/pg2lq/manage/basic/attachment/state',
  update = '/pg2lq/manage/basic/attachment/update',
  makeFileOwnerPublic = '/pg2lq/manage/basic/attachment/makeFileOwnerPublic',
  makeFileOwnerAllPublic = '/pg2lq/manage/basic/attachment/upload-makeFileOwnerAllPublic',
  updateByFileOwner = '/pg2lq/manage/basic/attachment/upload-updateByFileOwner',
}
