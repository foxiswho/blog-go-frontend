...
enum Api {
  create = '/xianfu/manage/basic/attachment/create',
  delete = '/xianfu/manage/basic/attachment/delete',
  detail = '/xianfu/manage/basic/attachment/detail/',
  disable = '/xianfu/manage/basic/attachment/disable',
  enable = '/xianfu/manage/basic/attachment/enable',
  existName = '/xianfu/manage/basic/attachment/existName',
  exportExcel = '/xianfu/manage/basic/attachment/exportExcel',
  list = '/xianfu/manage/basic/attachment/query',
  physicalDeletion = '/xianfu/manage/basic/attachment/physicalDeletion',
  recovery = '/xianfu/manage/basic/attachment/recovery',
  selectNodeAllPublic = '/xianfu/manage/basic/attachment/selectNodeAllPublic',
  selectNodePublic = '/xianfu/manage/basic/attachment/selectNodePublic',
  selectPublic = '/xianfu/manage/basic/attachment/selectPublic',
  state = '/xianfu/manage/basic/attachment/state',
  ...
  upload = '/xianfu/manage/basic/filePub/upload',
  uploadQr = '/xianfu/manage/basic/filePub/upload-qr',
  uploadLink = '/xianfu/manage/basic/filePub/upload-link',
  uploadList = '/xianfu/manage/basic/filePub/upload-list',
  updateByFileOwner = '/xianfu/manage/basic/filePub/upload-updateByFileOwner',
  updateDetail = '/xianfu/manage/basic/filePub/upload-detail',
}
