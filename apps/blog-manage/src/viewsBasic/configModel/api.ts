...
enum Api {
  create = '/pg2lq/manage/basic/config-model/create',
  createUpdate = '/pg2lq/manage/basic/config-model/createUpdate',
  delete = '/pg2lq/manage/basic/config-model/delete',
  detail = '/pg2lq/manage/basic/config-model/detail/',
  disable = '/pg2lq/manage/basic/config-model/disable',
  enable = '/pg2lq/manage/basic/config-model/enable',
  existName = '/pg2lq/manage/basic/config-model/existName',
  existCode = '/pg2lq/manage/basic/config-model/existCode',
  existValue = '/pg2lq/manage/basic/config-model/existValue',
  exportExcel = '/pg2lq/manage/basic/config-model/exportExcel',
  list = '/pg2lq/manage/basic/config-model/query',
  physicalDeletion = '/pg2lq/manage/basic/config-model/physicalDeletion',
  recovery = '/pg2lq/manage/basic/config-model/recovery',
  selectNodeAllPublic = '/pg2lq/manage/basic/config-model/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/manage/basic/config-model/selectNodePublic',
  selectPublic = '/pg2lq/manage/basic/config-model/selectPublic',
  state = '/pg2lq/manage/basic/config-model/state',
  update = '/pg2lq/manage/basic/config-model/update',
}
