...
enum Api {
  allByValueNo = '/pg2lq/manage/basic/modelRules/allByValueNo',
  create = '/pg2lq/manage/basic/modelRules/create',
  createUpdate = '/pg2lq/manage/basic/modelRules/createUpdate',
  delete = '/pg2lq/manage/basic/modelRules/delete',
  detail = '/pg2lq/manage/basic/modelRules/detail/',
  disable = '/pg2lq/manage/basic/modelRules/disable',
  enable = '/pg2lq/manage/basic/modelRules/enable',
  existName = '/pg2lq/manage/basic/modelRules/existName',
  existCode = '/pg2lq/manage/basic/modelRules/existCode',
  existValue = '/pg2lq/manage/basic/modelRules/existValue',
  exportExcel = '/pg2lq/manage/basic/modelRules/exportExcel',
  list = '/pg2lq/manage/basic/modelRules/query',
  physicalDeletion = '/pg2lq/manage/basic/modelRules/physicalDeletion',
  recovery = '/pg2lq/manage/basic/modelRules/recovery',
  selectNodeAllPublic = '/pg2lq/manage/basic/modelRules/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/manage/basic/modelRules/selectNodePublic',
  selectPublic = '/pg2lq/manage/basic/modelRules/selectPublic',
  state = '/pg2lq/manage/basic/modelRules/state',
  update = '/pg2lq/manage/basic/modelRules/update',
}
