...
enum Api {
  allByValueNo = '/xianfu/manage/basic/modelRules/allByValueNo',
  create = '/xianfu/manage/basic/modelRules/create',
  createUpdate = '/xianfu/manage/basic/modelRules/createUpdate',
  delete = '/xianfu/manage/basic/modelRules/delete',
  detail = '/xianfu/manage/basic/modelRules/detail/',
  disable = '/xianfu/manage/basic/modelRules/disable',
  enable = '/xianfu/manage/basic/modelRules/enable',
  existName = '/xianfu/manage/basic/modelRules/existName',
  existCode = '/xianfu/manage/basic/modelRules/existCode',
  existValue = '/xianfu/manage/basic/modelRules/existValue',
  exportExcel = '/xianfu/manage/basic/modelRules/exportExcel',
  list = '/xianfu/manage/basic/modelRules/query',
  physicalDeletion = '/xianfu/manage/basic/modelRules/physicalDeletion',
  recovery = '/xianfu/manage/basic/modelRules/recovery',
  selectNodeAllPublic = '/xianfu/manage/basic/modelRules/selectNodeAllPublic',
  selectNodePublic = '/xianfu/manage/basic/modelRules/selectNodePublic',
  selectPublic = '/xianfu/manage/basic/modelRules/selectPublic',
  state = '/xianfu/manage/basic/modelRules/state',
  update = '/xianfu/manage/basic/modelRules/update',
}
 ...
 * @param data
 */
export const allByValueNo = (data?: any) => {
  return requestClient.post(Api.allByValueNo, data);
};
/**
 * 公共列表展示
 * @param data
 ...
 * @param params
 */
export const deleteIds = (params: any, fieldNo: string) => {
