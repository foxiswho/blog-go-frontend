...
enum Api {
  allByValueNo = '/pg2lq/manage/basic/configEventFields/allByValueNo',
  ...
  detail = '/pg2lq/manage/basic/configEventFields/detail/',
  disable = '/pg2lq/manage/basic/configEventFields/disable',
  enable = '/pg2lq/manage/basic/configEventFields/enable',
  existName = '/pg2lq/manage/basic/configEventFields/existName',
  existCode = '/pg2lq/manage/basic/configEventFields/existCode',
  existValue = '/pg2lq/manage/basic/configEventFields/existValue',
  exportExcel = '/pg2lq/manage/basic/configEventFields/exportExcel',
  list = '/pg2lq/manage/basic/configEventFields/query',
  physicalDeletion = '/pg2lq/manage/basic/configEventFields/physicalDeletion',
  recovery = '/pg2lq/manage/basic/configEventFields/recovery',
  selectNodeAllPublic = '/pg2lq/manage/basic/configEventFields/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/manage/basic/configEventFields/selectNodePublic',
  selectPublic = '/pg2lq/manage/basic/configEventFields/selectPublic',
  state = '/pg2lq/manage/basic/configEventFields/state',
  update = '/pg2lq/manage/basic/configEventFields/update',
}
