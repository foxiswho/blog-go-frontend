...
enum Api {
  create = '/xianfu/manage/basic/dataDictionarySub/create',
  createUpdate = '/xianfu/manage/basic/dataDictionarySub/createUpdate',
  delete = '/xianfu/manage/basic/dataDictionarySub/delete',
  detail = '/xianfu/manage/basic/dataDictionarySub/detail/',
  disable = '/xianfu/manage/basic/dataDictionarySub/disable',
  enable = '/xianfu/manage/basic/dataDictionarySub/enable',
  existName = '/xianfu/manage/basic/dataDictionarySub/existName',
  existCode = '/xianfu/manage/basic/dataDictionarySub/existCode',
  existValue = '/xianfu/manage/basic/dataDictionarySub/existValue',
  exportExcel = '/xianfu/manage/basic/dataDictionarySub/exportExcel',
  list = '/xianfu/manage/basic/dataDictionarySub/query',
  physicalDeletion = '/xianfu/manage/basic/dataDictionarySub/physicalDeletion',
  recovery = '/xianfu/manage/basic/dataDictionarySub/recovery',
  selectNodeAllPublic = '/xianfu/manage/basic/dataDictionarySub/selectNodeAllPublic',
  selectNodePublic = '/xianfu/manage/basic/dataDictionarySub/selectNodePublic',
  selectPublic = '/xianfu/manage/basic/dataDictionarySub/selectPublic',
  state = '/xianfu/manage/basic/dataDictionarySub/state',
  update = '/xianfu/manage/basic/dataDictionarySub/update',
}
