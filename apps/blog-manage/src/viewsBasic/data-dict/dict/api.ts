...
enum Api {
  create = '/xianfu/manage/basic/dataDictionary/create',
  createUpdate = '/xianfu/manage/basic/dataDictionary/createUpdate',
  codeValueAllPublic = '/xianfu/manage/basic/dataDictionary/codeValueAllPublic',
  delete = '/xianfu/manage/basic/dataDictionary/delete',
  detail = '/xianfu/manage/basic/dataDictionary/detail/',
  disable = '/xianfu/manage/basic/dataDictionary/disable',
  enable = '/xianfu/manage/basic/dataDictionary/enable',
  existName = '/xianfu/manage/basic/dataDictionary/existName',
  existCode = '/xianfu/manage/basic/dataDictionary/existCode',
  existValue = '/xianfu/manage/basic/dataDictionary/existValue',
  exportExcel = '/xianfu/manage/basic/dataDictionary/exportExcel',
  list = '/xianfu/manage/basic/dataDictionary/query',
  physicalDeletion = '/xianfu/manage/basic/dataDictionary/physicalDeletion',
  recovery = '/xianfu/manage/basic/dataDictionary/recovery',
  selectNodeAllPublic = '/xianfu/manage/basic/dataDictionary/selectNodeAllPublic',
  selectNodePublic = '/xianfu/manage/basic/dataDictionary/selectNodePublic',
