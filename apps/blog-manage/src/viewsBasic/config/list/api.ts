...
enum Api {
  create = '/pg2lq/manage/basic/config-list/create',
  delete = '/pg2lq/manage/basic/config-list/delete',
  detail = '/pg2lq/manage/basic/config-list/detail/',
  disable = '/pg2lq/manage/basic/config-list/disable',
  enable = '/pg2lq/manage/basic/config-list/enable',
  existName = '/pg2lq/manage/basic/config-list/existName',
  exportExcel = '/pg2lq/manage/basic/config-list/exportExcel',
  list = '/pg2lq/manage/basic/config-list/query',
  physicalDeletion = '/pg2lq/manage/basic/config-list/physicalDeletion',
  recovery = '/pg2lq/manage/basic/config-list/recovery',
  selectNodeAllPublic = '/pg2lq/manage/basic/config-list/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/manage/basic/config-list/selectNodePublic',
