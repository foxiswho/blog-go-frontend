...
enum Api {
  create = '/pg2lq/manage/api/dipl/create',
  delete = '/pg2lq/manage/api/dipl/delete',
  cacheOverride = '/pg2lq/manage/api/dipl/cacheOverride',
  detail = '/pg2lq/manage/api/dipl/detail/',
  disable = '/pg2lq/manage/api/dipl/disable',
  enable = '/pg2lq/manage/api/dipl/enable',
  existName = '/pg2lq/manage/api/dipl/existName',
  exportExcel = '/pg2lq/manage/api/dipl/exportExcel',
  list = '/pg2lq/manage/api/dipl/query',
  physicalDeletion = '/pg2lq/manage/api/dipl/physicalDeletion',
  recovery = '/pg2lq/manage/api/dipl/recovery',
  selectCategoryPublic = '/pg2lq/manage/api/dipl/selectCategoryPublic',
  selectNodeAllPublic = '/pg2lq/manage/api/dipl/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/manage/api/dipl/selectNodePublic',
  selectPublic = '/pg2lq/manage/api/dipl/selectPublic',
  state = '/pg2lq/manage/api/dipl/state',
  update = '/pg2lq/manage/api/dipl/update',
}
