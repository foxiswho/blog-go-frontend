...
enum Api {
  create = '/xianfu/manage/api/dipl/create',
  delete = '/xianfu/manage/api/dipl/delete',
  cacheOverride = '/xianfu/manage/api/dipl/cacheOverride',
  detail = '/xianfu/manage/api/dipl/detail/',
  disable = '/xianfu/manage/api/dipl/disable',
  enable = '/xianfu/manage/api/dipl/enable',
  existName = '/xianfu/manage/api/dipl/existName',
  exportExcel = '/xianfu/manage/api/dipl/exportExcel',
  list = '/xianfu/manage/api/dipl/query',
  physicalDeletion = '/xianfu/manage/api/dipl/physicalDeletion',
  recovery = '/xianfu/manage/api/dipl/recovery',
  selectCategoryPublic = '/xianfu/manage/api/dipl/selectCategoryPublic',
  selectNodeAllPublic = '/xianfu/manage/api/dipl/selectNodeAllPublic',
  selectNodePublic = '/xianfu/manage/api/dipl/selectNodePublic',
  selectPublic = '/xianfu/manage/api/dipl/selectPublic',
  state = '/xianfu/manage/api/dipl/state',
  update = '/xianfu/manage/api/dipl/update',
}
