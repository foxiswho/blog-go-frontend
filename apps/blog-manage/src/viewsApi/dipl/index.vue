...
function rowEventAccessKey(row) {
  drawerAccessKeyApi.setData({
    // 表单值
    values: row,
    isUpdate: true,
  });
  drawerAccessKeyApi.open();
}
</script>
