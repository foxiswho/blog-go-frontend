...
enum Api {
  create = '/pg2lq/manage/api/dipl-access-key/create',
  delete = '/pg2lq/manage/api/dipl-access-key/delete',
  cacheOverride = '/pg2lq/manage/api/dipl-access-key/cacheOverride',
  detail = '/pg2lq/manage/api/dipl-access-key/detail/',
  disable = '/pg2lq/manage/api/dipl-access-key/disable',
  enable = '/pg2lq/manage/api/dipl-access-key/enable',
  existName = '/pg2lq/manage/api/dipl-access-key/existName',
  exportExcel = '/pg2lq/manage/api/dipl-access-key/exportExcel',
  list = '/pg2lq/manage/api/dipl-access-key/query',
  physicalDeletion = '/pg2lq/manage/api/dipl-access-key/physicalDeletion',
  recovery = '/pg2lq/manage/api/dipl-access-key/recovery',
  selectCategoryPublic = '/pg2lq/manage/api/dipl-access-key/selectCategoryPublic',
  selectNodeAllPublic = '/pg2lq/manage/api/dipl-access-key/selectNodeAllPublic',
  selectNodePublic = '/pg2lq/manage/api/dipl-access-key/selectNodePublic',
  selectPublic = '/pg2lq/manage/api/dipl-access-key/selectPublic',
  state = '/pg2lq/manage/api/dipl-access-key/state',
  update = '/pg2lq/manage/api/dipl-access-key/update',
  makeNew = '/pg2lq/manage/api/dipl-access-key/makeNew',
}
